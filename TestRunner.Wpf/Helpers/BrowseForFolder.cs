//<auto-generated />
// Code from: https://www.pinvoke.net/default.aspx/shell32.shbrowseforfolder
...
public class BrowseForFolder
{
    ...
    public string SelectFolder(string caption, string initialPath, IntPtr parentHandle)
    {
        ...
        BROWSEINFO bi = new()
        {
            ...
            lpszTitle = caption,
            ulFlags = BIF_RETURNONLYFSDIRS | BIF_EDITBOX | BIF_STATUSTEXT | BIF_VALIDATE |  BIF_NEWDIALOGSTYLE,
